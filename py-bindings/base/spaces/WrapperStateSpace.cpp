...
void ompl::binding::base::initSpaces_WrapperStateSpace(nb::module_ &m)
{
    ...
    nb::class_<ob::WrapperStateSpace, ob::StateSpace, PyWrapperStateSpace>(m, "WrapperStateSpace")
        ...
        .def("includes", nb::overload_cast<const ob::StateSpace *>(&ob::WrapperStateSpace::includes, nb::const_),
             nb::arg("other"))
        .def("covers", nb::overload_cast<const ob::StateSpace *>(&ob::WrapperStateSpace::covers, nb::const_),
             nb::arg("other"))
        ...
        .def("getValueAddressAtIndex",
             nb::overload_cast<ob::State *, unsigned int>(&ob::WrapperStateSpace::getValueAddressAtIndex, nb::const_),
             nb::arg("state"), nb::arg("index"))
        .def("getValueAddressAtLocation",
             nb::overload_cast<ob::State *, const ob::StateSpace::ValueLocation &>(
                 &ob::WrapperStateSpace::getValueAddressAtLocation, nb::const_),
             nb::arg("state"), nb::arg("loc"))
        ...
        .def("sanityChecks",
             nb::overload_cast<double, double, unsigned int>(&ob::WrapperStateSpace::sanityChecks, nb::const_),
